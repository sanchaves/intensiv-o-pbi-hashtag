📊 Intensivão de Power BI — Projetos e Estudos
...
- Total reprovado: 21.076
- Horas produtivas: 30.956
- Horas paradas: 8.890
- Gráfico de linha mensal mostrando a evolução do total aprovado por mês, com destaque para os meses de maior e menor produtividade.
- Medidores circulares com métricas de eficiência:
...
- Distribuição geográfica dos funcionários ativos por cidade, com destaque para São Paulo, Recife e Rio de Janeiro.
- Distribuição por gênero, apresentada em gráfico de pizza.
